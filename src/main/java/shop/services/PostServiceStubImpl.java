...
public class PostServiceStubImpl implements PostService {
    ...
    private List<Post> posts = new LinkedList<Post>(){{
        add(new Post(1L, "First Post", "<p>Line #1.</p><p>Line #2</p>", user1,Calendar.getInstance()));
        add(new Post(2L, "Second Post",
                "<p>Second post content:<ul><li>line 1</li><li>line 2</li></ul></p>",
                null,changeCalendar(Calendar.getInstance(),2017,4,12)));
        add(new Post(3L, "Post #3", "<p>The post number 3 nice</p>",
                user1,changeCalendar(Calendar.getInstance(),2017,4,13)));
        add(new Post(4L, "Forth Post", "<p>Not interesting post</p>", user1,Calendar.getInstance()));
        add(new Post(5L, "Post Number 5", "<p>Just posting nanan\naaa\naaa\nnnnnnnnnnnnnnnnnnnnnnn" +
                "nnnnnnnnn\nnnnnnnnnnnnnnnnnnn\nnnnnnnnnnnnnnnnnnnn" +
                "nnnnnnnnnn\nnnnnnnnnnnnnnn\nnnnnnnnnnnnnnnnnnn" +
                "nnnnnnnnnnnnnnnnn\nnnnnnnnnnnnnnnnnnn</p>", user, changeCalendar(Calendar.getInstance(),2015,5,12)));
        add(new Post(6L, "Sixth Post", "<p>Another interesting post</p>", null,changeCalendar(Calendar.getInstance(),2017,3,17)));
    }};
    ...
    public List<Post> findLatest5() {
      return  posts.stream()
              .sorted(Comparator.comparing(Post::getCalendar))
